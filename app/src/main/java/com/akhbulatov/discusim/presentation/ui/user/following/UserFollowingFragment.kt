...
class UserFollowingFragment : BaseFragment() {
    ...
    private val viewModel: UserFollowingViewModel by viewModels { viewModelFactory }

    private val usersAdapter by lazy {
        UserAdapter { viewModel.onFollowingClicked(it) }
    }
    private val onScrollListener by lazy {
        EndlessScrollListener(followingRecyclerView.layoutManager as LinearLayoutManager) { viewModel.loadNextFollowingPage() }
    }
